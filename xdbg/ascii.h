...
#define MOVE_HOME "\x1b[0G"  //     moves cursor to home position
#define MOVE_TO "\x1b[%dG"  //     moves cursor to %d location 
#define MOVE_TOPLEFT "\x1b[H"  //     moves cursor to position(0, 0)
#define MOVE_UP "\x1b[A"    //     moves cursor up # lines
#define MOVE_DOWN "\x1b[B"  //     moves cursor down # lines
#define MOVE_RIGHT "\x1b[C" //     moves cursor right # columns
#define MOVE_LEFT "\x1b[D"  //     moves cursor left # columns
#define MOVE_END "\x1b[F"
#define BACKSPACE "\x1b[J"
#define SAVE_CURSOR "\x1b 7"
#define RESTORE_CURSOR "\x1b 8"
#define DELETE_LINE "\x1b[2K"
#define DEL_KEY "\x1b[3~"
#define MOVE_HOME_LONG 0x485b1b
#define MOVE_UP_LONG 0x415b1b
#define MOVE_DOWN_LONG 0x425b1b
#define MOVE_RIGHT_LONG 0x435b1b
#define MOVE_LEFT_LONG 0x445b1b
#define MOVE_END_LONG 0x465b1b
#define DEL_KEY_LONG 0x7e335b1b
#define CTRL_LEFT_LONG 0x44353b315b1b
#define CTRL_RIGHT_LONG 0x43353b315b1b
